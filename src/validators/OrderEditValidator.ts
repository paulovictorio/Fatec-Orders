...
export const OrderEditValidator = () => {
    ...
    return Yup.object().shape({
        ...
        itensQtd: Yup.number().required("A quantidade de itens é obrigatória").min(1, "O numero de itens não pode ser 0"),
        totalValue: Yup.number().required("O valor total é obrigatório").min(0.01, "O valor não pode ser 0 nem negativo"),
    });
